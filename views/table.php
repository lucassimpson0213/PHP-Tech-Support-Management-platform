...
function list_products() {
   ...
   foreach ($products as $product_details) {
        ...
        $table .= '<td>';
        $table .= '<form method="POST" action="delete_product.php">';
        $table .= '<input type="hidden" name="productCode" value="' . $product_details['productCode'] . '">';
        $table .= '<button type="submit">Delete</button>';
        $table .= '</form>';
        $table .= '</td>';
